...
namespace Cesgranrio.CorretorDeProvas.Simulador
{
    ...
    public partial class frmSimulador : Form
    {
        ...
        const string formato = "N2";
        static List<Task> tarefas;
        readonly ParallelOptions opcaoParalelismo;
        
        public frmSimulador()
        {
            InitializeComponent();
            opcaoParalelismo= new ParallelOptions() { MaxDegreeOfParallelism = TOTAL_THREADS };
